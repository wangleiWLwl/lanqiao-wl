...
public class Product {
    ...
    public String getProductSmallPrice() {
        return productSmallPrice;
    }
    public void setProductSmallPrice(String productSmallPrice) {
    ...
    public String getProductLargerPrice() {
        return productLargerPrice;
    }
    public void setProductLargerPrice(String productLargerPrice) {
    ...
    public String getProductIsLack() {
        return productIsLack;
    }
    public void setProductIsLack(String productIsLack) {
    ...
    public String getProductSuggestPrice() {
        return productSuggestPrice;
    }
    public void setProductSuggestPrice(String productSuggestPrice) {
